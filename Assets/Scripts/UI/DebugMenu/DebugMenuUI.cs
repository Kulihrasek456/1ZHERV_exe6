...
#region Interface
    ...
    private float lastNonMinVolume = 0f;
        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                /*
                    ...
                    */
                GameManager.Instance.interactiveMode = GUILayout.Toggle(GameManager.Instance.interactiveMode, "interactive mode");
                ...
                masterVolume = GUILayout.HorizontalSlider(SoundManager.Instance.masterVolume, -80.0f, 20.0f, GUILayout.ExpandWidth(true));
                ...
                if (GUILayout.Toggle(SoundManager.Instance.masterMuted, "master mute"))
                {
                ...
                else
                {
                    ...
                    SoundManager.Instance.masterVolume = lastNonMinVolume;
                }
